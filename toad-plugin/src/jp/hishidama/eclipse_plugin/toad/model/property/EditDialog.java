...
public abstract class EditDialog extends Dialog {
	...
	protected Combo createComboField(Composite composite, String label, String init, List<String> list) {
		createLabel(composite, label);
	...
	protected final boolean refreshOkButton() {
